        ...
        <van-swipe  indicator-color="white">
         ...
         <van-cell-group>
            <van-cell v-if="hasRush && sourceType=='rusnNow'" title="结束时间" >
                 <van-tag plain  type="danger" > <count-down  :time="endTime.replace(/\-/g, '/')" :callback="TimeOutCallback" ></count-down > </van-tag>
            </van-cell>
...
import { IsNumber,IsFloatNumber,compareObj} from '@/libs/tools'
