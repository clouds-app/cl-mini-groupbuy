...
*/
export const addressSave = ({ userId }) => {
    //debugger
    //参数
    const data = {
      //userId
    ...
    return axios.request({
      url: `/api/user/address/save/${userId}`,
      data,
      method: 'post',
      transformRequest: [function (data) {
        // 对 data 进行任意转换处理
...
*/
export const addressUpdate = ({ userId }) => {
    //debugger
    //参数
    const data = {
      //userId
    ...
    return axios.request({
      url: `/api/user/address/update/${userId}`,
      data,
      method: 'post',
      transformRequest: [function (data) {
        // 对 data 进行任意转换处理
...
export const addressDelete = ({ userId,addressId }) => {
    ...
    return axios.request({
      url: `/api/user/address/delete/${userId}/${addressId}`,
      data,
      method: 'post',
      transformRequest: [function (data) {
        // 对 data 进行任意转换处理
...
*/
export const addressDetail = ({ userId,addressId }) => {
    //debugger
    //参数
    const data = {
      //userId,
