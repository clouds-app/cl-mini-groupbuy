  ...
  <div>
      ...
      <van-cell-group>
        ...
        <van-field
          ...
          right-icon="question-o"
          placeholder="请输入电话号码"
          @click-right-icon="$toast('请输入电话号码')"
        />
        <van-field
      ...
      <div class="form-group">
        <van-button :loading='isLoding'  round style="margin-right:10px;width:300px;" type="info" @click="handleSubmit">确 认</van-button>
